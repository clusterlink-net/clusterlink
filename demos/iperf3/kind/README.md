...
### <ins> Step 2: Create Kind clusters with Clusterlink gateway <ins>
...
4) Create peer2 certificates and deployment file:
        ...
        $PROJECT_DIR/bin/cl-adm  create peer --name peer2
...
### <ins> Step 7: Create access policy <ins>
