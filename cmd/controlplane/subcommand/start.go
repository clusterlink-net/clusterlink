...
func init() {
	...
	startCmd.Flags().String("cportLocal", "443", "Multi-cloud Border Gateway control local port inside the MBG")
	startCmd.Flags().String("cport", "443", "Multi-cloud Border Gateway control external port for the MBG neighbors ")
	...
	startCmd.Flags().String("certca", "", "Path to the Root Certificate Auth File (.pem)")
	startCmd.Flags().String("cert", "", "Path to the Certificate File (.pem)")
