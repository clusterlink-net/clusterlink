...
type DisconnectClient interface {
	// Sends a connect message
	DisconnectCmd(ctx context.Context, in *DisconnectRequest, opts ...grpc.CallOption) (*DisconnectReply, error)
}
...
func (c *disconnectClient) DisconnectCmd(ctx context.Context, in *DisconnectRequest, opts ...grpc.CallOption) (*DisconnectReply, error) {
	out := new(DisconnectReply)
	err := c.cc.Invoke(ctx, "/protocol.Disconnect/DisconnectCmd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DisconnectServer interface {
	// Sends a connect message
	DisconnectCmd(context.Context, *DisconnectRequest) (*DisconnectReply, error)
...
func (UnimplementedDisconnectServer) DisconnectCmd(context.Context, *DisconnectRequest) (*DisconnectReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DisconnectCmd not implemented")
}
...
func _Disconnect_DisconnectCmd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DisconnectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DisconnectServer).DisconnectCmd(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.Disconnect/DisconnectCmd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DisconnectServer).DisconnectCmd(ctx, req.(*DisconnectRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Disconnect_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protocol.Disconnect",
	HandlerType: (*DisconnectServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DisconnectCmd",
			Handler:    _Disconnect_DisconnectCmd_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protocol.proto",
