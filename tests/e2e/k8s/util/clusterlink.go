...
func (c *ClusterLink) WaitForImportCondition(
	...
	return c.cluster.WaitFor(imp, &imp.Status.Conditions, conditionType, conditionStatus)
}
...
func (c *ClusterLink) WaitForExportCondition(
	...
	return c.cluster.WaitFor(export, &export.Status.Conditions, conditionType, conditionStatus)
}
...
func (c *ClusterLink) WaitForPeerCondition(
	...
	return c.cluster.WaitFor(peer, &peer.Status.Conditions, conditionType, conditionStatus)
}
