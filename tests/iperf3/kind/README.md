...
Initialize gwctl (mbg control):
    ...
    kubectl exec -i $MBGCTL1 -- ./gwctl create --id "gwctl1" --mbgIP $MBG1PODIP:8443 --dataplane mtls --rootCa ./mtls/ca.crt --certificate ./mtls/mbg1.crt --key ./mtls/mbg1.key
...
Initialize gwctl (mbg control):
    ...
    kubectl exec -i $MBGCTL2 -- ./gwctl create --id "gwctl2" --mbgIP $MBG2PODIP:8443 --dataplane mtls --rootCa ./mtls/ca.crt --certificate ./mtls/mbg2.crt --key ./mtls/mbg2.key
